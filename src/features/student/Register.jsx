...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.courseType === "OTHER" && !formData.otherCourse.trim()) {
      showToast("Please enter the other course name ❌");
      return;
    }
    ...
    const newCert = {
      ...
      otherCourse:
        formData.courseType === "OTHER" ? formData.otherCourse.trim() : "",
    };
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              >
                ...
                <option value="EC_COUNCIL_ETHICAL_HACKING">
